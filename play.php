...
<main class="container py-5">
  <div class="row g-4">
    ...
    <div class="col-lg-6 d-flex flex-column justify-content-center align-items-center">
      <div class="card bg-secondary text-light w-100 p-4 shadow">
        <h2 class="text-center fw-bold mb-3">Guess the word</h2>
        <h1 id="Word" class="display-4 text-center my-3">_ _ _ _ _</h1>
        <input type="text" id="Guess" class="form-control mb-3 text-center" placeholder="Type your guess">
        <button class="btn btn-warning w-100 mb-3 fw-bold" id="Check" onclick="Check()">Check</button>
        <div class="text-center">
          <h5 class="fw-bold">Correct words:</h5>
          <div id="Counter" class="display-6">0</div>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-6">
      <div class="card bg-secondary text-light p-4 shadow">
        <h4 class="text-center fw-bold mb-3">Timer</h4>
        <div id="Timer" class="display-6 text-center mb-4">00:00:00</div>
        ...
        <img src="img/Countdown.jpg" class="img-fluid rounded shadow" alt="Countdown Game Image">
      </div>
    </div>
